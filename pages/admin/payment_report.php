...
function myFunction() {
  ...
  if (from_date =='' || to_date =='' || class_id =='' ) {
    ...
    var WindowObject= window.open("print_payment_list.php?from="+from_date+"&to="+to_date+"&class_id="+class_id , "", "toolbar=yes,scrollbars=yes,resizable=yes,top=0,left=0,width=1000,height=500");
     WindowObject.focus();
    WindowObject.print();
    //WindowObject.close();
  }
