...
<?php include("include/sidebar.php");?>
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1 style="color:#27AE60;text-transform: uppercase;">
...
//mail($to, $subject, $body, $headers);
  ...
  <div class="box box-info collapsed-box">
            <div class="box-header with-border">
              ...
              <h3 class="box-title" style="color:#27AE60;text-transform: uppercase;font-weight: bold;font-size: 14px">Quick Email</h3>
 ...
 <!-- <div id="chart-2"> FusionCharts will render here--</div> -->
     ...
     <div class="col-md-5">
          ...
          <div class="box box-default collapsed-box">
            <div class="box-header with-border">
              <h3 class="box-title" style="color:#27AE60;text-transform: uppercase;font-weight: bold;font-size: 14px">Upcoming Events</h3>
