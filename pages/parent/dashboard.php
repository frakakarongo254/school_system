                    ...
                    if($tol <=0){
                      $total_balance =0.00;
                       ...
                       $total_balance=$tol;
                        ...
                        echo  $school_row['currency'] . ' <b>  '.formatCurrency($total_balance).'</b>';
                      ?>
                    </b></span>
       ...
       <div class="box box-default">
        ...
        <table id="example1" class="table table-bordered table-striped table-responsive">
          <thead>
              ...
              $query_event = mysqli_query($conn,"select * from event where school_ID = '".$school_ID."' and event_for='All' || event_for='Parent' || student_ID='".$stdID."' ORDER BY event_startDate DESC ")or
              die(mysqli_error());

              foreach ($query_event as $event_row) {
              $start=$event_row["event_startDate"];
              $event_startDate = date("d-m-Y", strtotime($start));
              $event_starttime = $event_row['event_startime'];
              $end=$event_row["event_endDate"];
                      ...
                      <div class="nav-tabs-custom">
                            ...
                            <div class="tab-content">
                              <div class="tab-pane active" id="invoice_tab">
                                    ...
                                    <tbody>
                                    <?php
                                    $query33=mysqli_query($conn,"select  parent_relation.student_ID, parent_relation.parent_ID from parent_relation where parent_relation.school_ID = '".$school_ID."' && parent_relation.parent_ID='".$login_parent_ID."'");
                              ...
                              <div class="tab-pane table-responsive" id="payment_tab">
                               ...
                               <tr>
                                 ...
                                 <td style="text-align: right;"><b style="font-size: 18px;font-weight: bold;"><?php echo $school_row["currency"] . " " .formatCurrency($total_amount_p)?></b></td>
                               </tr>
                                </tbody>
